...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<ResponseMessage> handleGenericException(Exception ex) {
        return new ResponseEntity<>(new ResponseMessage(HttpStatus.INTERNAL_SERVER_ERROR.value(), List.of(),ConstantMessage.SOMETHING_WENT_WRONG),HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
